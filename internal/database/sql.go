...
func (q SqlTx) ExecContext(ctx context.Context, query string, args ...interface{}) (sql.Result, error) {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, q.Hostname, q.DatabaseName, "tx.write.ExecContext", time.Since(curr)) }()
...
func (q SqlTx) GetContext(ctx context.Context, dest interface{}, query string, args ...interface{}) error {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, q.Hostname, q.DatabaseName, "tx.read.GetContext", time.Since(curr)) }()
	query = q.Tx.Rebind(query)
...
func (q SqlTx) NamedExecContext(ctx context.Context, query string, arg interface{}) (sql.Result, error) {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, q.Hostname, q.DatabaseName, "tx.write.NamedExec", time.Since(curr)) }()
	query = q.Tx.Rebind(query)
...
func (q SqlTx) PrepareContext(ctx context.Context, query string) (*sql.Stmt, error) {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, q.Hostname, q.DatabaseName, "tx.Prepare", time.Since(curr)) }()
	query = q.Tx.Rebind(query)
...
func (q SqlTx) QueryContext(ctx context.Context, query string, args ...interface{}) (*sql.Rows, error) {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, q.Hostname, q.DatabaseName, "tx.read.QueryRows", time.Since(curr)) }()
	query = q.Tx.Rebind(query)
...
func (q SqlTx) QueryRowContext(ctx context.Context, query string, args ...interface{}) *sql.Row {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, q.Hostname, q.DatabaseName, "tx.read.QueryRow", time.Since(curr)) }()
	query = q.Tx.Rebind(query)
...
func (q SqlTx) SelectContext(ctx context.Context, dest interface{}, query string, args ...interface{}) error {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, q.Hostname, q.DatabaseName, "tx.read.Select", time.Since(curr)) }()
	query = q.Tx.Rebind(query)
...
func (ds SQL) ExecContext(ctx context.Context, query string, args ...interface{}) (sql.Result, error) {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, ds.Hostname, ds.DatabaseName, "sql.write.ExecContext", time.Since(curr)) }()
...
func (ds SQL) GetContext(ctx context.Context, dest interface{}, query string, args ...interface{}) error {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, ds.Hostname, ds.DatabaseName, "sql.read.GetContext", time.Since(curr)) }()
	query = ds.DB.Rebind(query)
	queryable := ds.getQueryableFromContext(ctx)
...
func (ds SQL) NamedExecContext(ctx context.Context, query string, arg interface{}) (sql.Result, error) {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, ds.Hostname, ds.DatabaseName, "sql.write.NamedExec", time.Since(curr)) }()
	query = ds.DB.Rebind(query)
	queryable := ds.getQueryableFromContext(ctx)
...
func (ds SQL) PrepareContext(ctx context.Context, query string) (*sql.Stmt, error) {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, ds.Hostname, ds.DatabaseName, "sql.Prepare", time.Since(curr)) }()
	query = ds.DB.Rebind(query)
	queryable := ds.getQueryableFromContext(ctx)
...
func (ds SQL) QueryContext(ctx context.Context, query string, args ...interface{}) (*sql.Rows, error) {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, ds.Hostname, ds.DatabaseName, "sql.read.QueryRows", time.Since(curr)) }()
	query = ds.DB.Rebind(query)
	queryable := ds.getQueryableFromContext(ctx)
...
func (ds SQL) QueryRowContext(ctx context.Context, query string, args ...interface{}) *sql.Row {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, ds.Hostname, ds.DatabaseName, "sql.read.QueryRow", time.Since(curr)) }()
	query = ds.DB.Rebind(query)
	queryable := ds.getQueryableFromContext(ctx)
...
func (ds SQL) SelectContext(ctx context.Context, dest interface{}, query string, args ...interface{}) error {
	curr := time.Now()
	defer func() { recordQueryStat(ctx, ds.Hostname, ds.DatabaseName, "sql.read.Select", time.Since(curr)) }()
	query = ds.DB.Rebind(query)
	queryable := ds.getQueryableFromContext(ctx)
